...
namespace UnitTests.Reviews
{
    public class ReviewsServiceTests
    {
        ...
        {
            this._mockRepository = new Mock<IReviewsRepository>();
            this._service = new ReviewsService(_mockRepository.Object);
        }
        ...
        public void ResetReviewFlags_SetsNumberOfFlagsToZero()
        {
            ...
            this._mockRepository.Setup(review => review.GetReviewById(reviewId)).Returns(review);

            // Act
            _service.ResetReviewFlags(reviewId);

            // Assert
            this._mockRepository.Verify(review => review.UpdateNumberOfFlagsForReview(reviewId, 0), Times.Once);
        }
        ...
        public void HideReview_SetsIsHiddenToTrue()
        {
            ...
            // Assert
            this._mockRepository.Verify(review => review.UpdateReviewVisibility(reviewId, true), Times.Once);
        }
        ...
        public void GetFlaggedReviews_ReturnsReviewsWithFlags()
        {
            ...
            this._mockRepository.Setup(review => review.GetAllReviews()).Returns(reviews);
        ...
        public void GetAllReviews_ReturnsAllReviews()
        {
            ...
            this._mockRepository.Verify(review => review.GetAllReviews(), Times.Once);
        }
        ...
        public void GetReviewsSince_ReturnsReviewsAfterDate()
        {
            ...
            this._mockRepository.Setup(review => review.GetReviewsSince(date)).Returns(reviews.Where(review => review.CreatedDate >= date && !review.IsHidden).ToList());
            ...
            this._mockRepository.Verify(review => review.GetReviewsSince(date), Times.Once);
        }
        ...
        public void GetAverageRatingForVisibleReviews_ReturnsCorrectAverage()
        {
            ...
            this._mockRepository.Setup(review => review.GetAverageRatingForVisibleReviews()).Returns(expectedAverage);
            ...
            this._mockRepository.Verify(review => review.GetAverageRatingForVisibleReviews(), Times.Once);
        }
        ...
        public void GetMostRecentReviews_ReturnsCorrectNumberOfReviews()
        {
            ...
            this._mockRepository.Setup(review => review.GetMostRecentReviews(count)).Returns(reviews.OrderByDescending(review => review.CreatedDate).Take(count).ToList());
            ...
            this._mockRepository.Verify(review => review.GetMostRecentReviews(count), Times.Once);
        }
        ...
        public void GetReviewCountAfterDate_ReturnsCorrectCount()
        {
            ...
            var date = DateTime.Now.AddDays(-2);
            int expectedCount = 5;
            this._mockRepository.Setup(review => review.GetReviewCountAfterDate(date)).Returns(expectedCount);
            ...
            this._mockRepository.Verify(review => review.GetReviewCountAfterDate(date), Times.Once);
        }
        ...
        public void GetReviewsByUser_ReturnsCorrectReviews()
        {
            ...
            this._mockRepository.Setup(review => review.GetReviewsByUser(userId)).Returns(reviews.Where(review => review.UserId == userId && !review.IsHidden).OrderByDescending(review => review.CreatedDate).ToList());
            ...
            this._mockRepository.Verify(review => review.GetReviewsByUser(userId), Times.Once);
        }
        ...
        public void GetReviewsForReport_ReturnsRecentReviews()
        {
            ...
            this._mockRepository.Setup(review => 
            ...
            this._mockRepository.Verify(review => review.GetReviewCountAfterDate(It.Is<DateTime>(d => d.Date == date.Date)), Times.Once);
            this._mockRepository.Verify(review => review.GetMostRecentReviews(2), Times.Once);
        }
        ...
        public void FilterReviewsByContent_WithMatchingContent_ReturnsFilteredReviews()
        {
            ...
            this._mockRepository.Setup(repo => repo.GetAllReviews()).Returns(reviews);

            // Act
            var filtered = _service.FilterReviewsByContent(content);

            // Assert
            Assert.Equal(2, filtered.Count);
            Assert.All(filtered, r => Assert.Contains("great", r.Content, StringComparison.OrdinalIgnoreCase));
            this._mockRepository.Verify(repo => repo.GetAllReviews(), Times.Once);
        }
        ...
        public void FilterReviewsByContent_WithNullOrEmptyContent_ReturnsAllFlaggedReviews()
        {
            ...
            // Act
            var resultWithNull = _service.FilterReviewsByContent(null);
            var resultWithEmpty = _service.FilterReviewsByContent("");

            // Assert
            Assert.Equal(3, resultWithNull.Count);
            Assert.Equal(3, resultWithEmpty.Count);
            this._mockRepository.Verify(repo => repo.GetAllReviews(), Times.Exactly(2));
        }
    }
}
